        ...
        return (
            <div className="container-sm monographs-list">
                ...
                <div style={{textAlign: 'right'}}>
                    <Pagination size="small" current={this.store.currentPage} pageSize={16} style={{marginTop: 30, marginBottom: 30}} onChange={(page, size)=>{this.store.changePage(page)}} defaultCurrent={this.store.currentPage} total={this.store.total} />
                </div>
            </div>
        )
    }
