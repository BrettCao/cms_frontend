...
class JournalController extends Controller
{
    public function getIndex()
    {
        ...
        $this->layoutData['content'] = View::make('admin.pages.journal', array('pages' => Page::getJournalFrontierView(0), 'add_page' => Auth::action('pages.add'), 'page_states' => Auth::user()->getPageStates(), 'max' => Page::at_limit(), 'rootPageIds' => '', 'groups_exist' => PageGroup::count(),'page'=>$childPages));
    ...
    public function getAdd($parentPageId = 0, $groupId = 0)
    {
        ...
        list($tab_headers[0], $tab_contents[0]) = $page->tabInfoJournal();
        ksort($tab_headers);
...
//        dd($tab_data);
        $this->layoutData['content'] = View::make('admin.pages.journal_add', [
            'page' => $page,
            'item_name' => $item_name,
            'tab' => $tab_data
        ]);
