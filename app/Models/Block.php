...
class Block extends \CoasterCms\Models\Block
{
     ...
     * @return array
     */
    public static function getCategoryTabs($categorisedBlocks, $blockContents, $pageId = 0, $versionId = 0)
    {

        $tabHeaders = [];
        $tabContents = [];
        $category = BlockCategory::preload(5);
        ...
        foreach ($categorisedBlocks[5] as $blockId => $block) {
            /** @var Block $block */
