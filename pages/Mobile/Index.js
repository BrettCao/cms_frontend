...
import styles from  '../Password/index.module.css';
        ...
        return (
            <MemberLayout >
                <div className="member-details">
                    ...
                    <div>验证码</div>
                    <Search onChange={this.state.changeCode.bind(this.state)} placeholder="输入验证码" onSearch={this.state.sendCode.bind(this.state)}
