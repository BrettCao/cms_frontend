...
<div class="row">
    ...
    <div class="col-sm-6 text-right">
        @if ($add_page)
            <a href="{{ route('coaster.admin.news_category.add') }}" class="btn btn-warning addButton" data-page="0"><i
                        class="fa fa-plus"></i>新增期刊快报分类</a>
        @endif
    </div>
</div>
    ...
    <script type='text/javascript'>
        ...
        $(document).ready(function () {
            ...
            $('.addPage').click(function () {
                ...
                cms_alert('danger', 'Max Page Reached');
            });
            @endif
          ...
          var search = {
            ...
            doSearch: function()
            {
              ...
              search.ajaxCall = $.ajax({
                type: 'POST',
                  url: route('coaster.admin.api.search') + '?rnfd'+ Math.random(),
