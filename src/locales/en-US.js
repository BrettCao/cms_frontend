export default {
  ...
  'menu.system.cdn': 'Acceleration settings',
  'menu.system.user': 'Admin Settings',
  'menu.system.role': 'role settings',
  'menu.system.log': 'Operation log',


  'menu.cms': 'Content Management',
  'menu.cms.news': 'News management',
  'menu.cms.news.list': 'News list',
  'menu.cms.news.add': 'News increase',

  'menu.cms.news.detail' : 'News detail'
};
