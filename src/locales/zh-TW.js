export default {
  ...
  'menu.system.cdn': '加速設置',
  'menu.system.user': '管理員設置',
  'menu.system.role': '角色設置',
  'menu.system.log': '操作日誌',


  'menu.cms': '內容管理',
  'menu.cms.news': '新聞管理',
  'menu.cms.news.list': '新聞列表',
  'menu.cms.news.add': '新聞增加',

  'menu.cms.news.detail' : '新聞詳情',
};
