export default {
  ...
  'menu.scmet': '首页管理',
  'menu.scmet.homeBanner': '首页banner',
  'menu.scmet.columnBanner': '栏目banner',
  'menu.scmet.bottomManage': '底部管理',
  ...
  'menu.system.cdn': '加速设置',
  'menu.system.user': '管理员设置',
  'menu.system.role': '角色设置',
  'menu.system.log': '操作日志',

  'menu.cms': '内容管理',
  'menu.cms.news': '新闻管理',
  'menu.cms.news.list': '新闻列表',
  'menu.cms.news.add': '新闻增加',
  'menu.cms.news.categories': '新闻分类列表',
  'menu.cms.nav': '导航管理',
  'menu.cms.nav.navmng': '导航管理',
  'menu.cms.nav.navadd': '添加导航',
  'menu.cms.nav.navedit': '编辑导航',
  'menu.cms.nav.navsee': '查看导航',
  'menu.cms.prod': '产品管理',
  'menu.cms.prod.prodmng': '产品管理',
  'menu.cms.prod.prodadd': '添加产品',
  'menu.cms.prod.prodclamng': '产品分类管理',
  'menu.cms.case': '案例管理',
  'menu.cms.case.casemng': '案例管理',
  'menu.cms.case.caseadd': '添加案例',
  'menu.cms.case.caseclamng': '案例分类管理',
  'menu.cms.solve': '解决方案管理',
  'menu.cms.solve.solvemng': '解决方案管理',
  'menu.cms.solve.solveadd': '添加解决方案',
  'menu.cms.solve.solveclamng': '解决方案分类管理',
  'menu.cms.page': '单页管理',
  'menu.cms.page.pagemng': '单页管理',
  'menu.cms.page.pageadd': '添加单页',

  'menu.advpic': '广告图片管理',
  'menu.advpic.adv': '广告管理',
  'menu.advpic.adv.advmng': '广告管理',
  'menu.advpic.adv.advadd': '添加广告',
  'menu.advpic.pic': '图片管理',
  'menu.advpic.pic.picmng': '图片管理',
  'menu.advpic.pic.picadd': '添加图片',

  'menu.ability': '人才管理',
  'menu.ability.recruit': '招聘管理',
  'menu.ability.recruit.recruitmng': '招聘管理',
  'menu.ability.recruit.recruitadd': '添加招聘',

  'menu.quelea': '问题留言管理',
  'menu.quelea.quest': '问题管理',
  'menu.quelea.quest.quemng': '问题管理',
  'menu.quelea.quest.queedit': '编辑问题',
  'menu.quelea.faq': 'FAQ管理',
  'menu.quelea.faq.faqmng': 'FAQ管理',
  'menu.quelea.faq.faqadd': '添加FAQ',
  'menu.quelea.faq.faqclamng': 'FAQ分类管理',
  'menu.quelea.leave': '留言管理',
  'menu.quelea.leave.leavemng': '留言管理',
  'menu.quelea.leave.leavedetail': '留言详情',

  'menu.downlink': '下载链接管理',
  'menu.downlink.down': '下载管理',
  'menu.downlink.down.downmng': '下载管理',
  'menu.downlink.down.downadd': '添加下载文件',
  'menu.downlink.down.downclamng': '下载分类管理',
  'menu.downlink.link': '链接管理',
  'menu.downlink.link.linkmng': '链接管理',
  'menu.downlink.link.linkadd': '添加链接',

  'menu.website': '网点管理',
  'menu.website.web': '网点管理',
  'menu.website.web.webmng': '网点管理',
  'menu.website.web.webadd': '添加网点',
};
