...
import styles from './ProdMng.less';
...
@Form.create()
class ProdMng extends PureComponent {
  state = {
    selectedRows: [],
    formValues: {},
  };
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Button.Group>
                <Button icon="plus" onClick={() => router.push('/cms/prod/prodadd')}>
                  添加产品
                </Button>
                <Button icon="swap" onClick={this.toggle}>
                  显隐
                </Button>
                <Button icon="home" onClick={this.toggle}>
                  首页显示
                </Button>
                <Button icon="menu" onClick={this.toggle}>
                  导航显示
                </Button>
