...
import { Row, Col, Form, Input, Radio, Select, Button, Table } from 'antd';
import styles from './SolveClaMng.less';
...
@Form.create()
class SolveClaMng extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
