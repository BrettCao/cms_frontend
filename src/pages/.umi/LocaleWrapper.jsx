...
const localeInfo = {
  'en-US': {
    messages: require('/Users/brett/Sites/cmsfrontend/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: require('/Users/brett/Sites/cmsfrontend/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('/Users/brett/Sites/cmsfrontend/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
