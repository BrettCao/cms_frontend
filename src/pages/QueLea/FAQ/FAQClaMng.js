...
import styles from './FAQClaMng.less';
...
@Form.create()
class FAQClaMng extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
          ...
          <Row>
            <FormItem label="语言：">
              {getFieldDecorator('navname')(
                <Select defaultValue="中文" style={{ width: 120 }} onChange={handleChange}>
