...
import styles from './QueMng.less';
...
@Form.create()
class QueMng extends PureComponent {
  state = {
    selectedRows: [],
    formValues: {},
  };
            ...
            <FormItem label="回答状态：">
              {getFieldDecorator('status')(
                <Select style={{ width: '100%' }}>
                  <Option value="运行中">全部</Option>
                  <Option value="全部">已回答</Option>
                  <Option value="全部">未回答</Option>
                </Select>
              )}
            </FormItem>
          </Col>
